    ...
    return (
        <div className='md:px-20 px-10'>
            <div className='lg:w-8/12 md:w-10/12 md:p-10 p-3 my-10 bg-white custom_shadow rounded-xl   mx-auto'>
                ...
                <div tabIndex="1" className=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div className="collapse-title text-xl font-medium">
                ...
                <div tabIndex="2" className=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div className="collapse-title text-xl font-medium">
                ...
                <div tabIndex="3" className=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div className="collapse-title text-xl font-medium">
                ...
                <div tabIndex="4" className=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div className="collapse-title text-xl font-medium">
