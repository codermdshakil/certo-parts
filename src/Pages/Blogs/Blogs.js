    ...
    return (
        <div className='md:px-20 px-10'>
            ...
            <h2 className='text-2xl mb-6 font-bold text-center'> <span className='text-3xl font-bold text-secondary'>Q</span>uestion and <span className='text-3xl font-bold text-primary'>A</span>nswer</h2>
                <div tabindex="0" class=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                ...
                <div tabindex="1" class=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div class="collapse-title text-xl font-medium">
                ...
                <div tabindex="2" class=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div class="collapse-title text-xl font-medium">
                ...
                <div tabindex="3" class=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div class="collapse-title text-xl font-medium">
                ...
                <div tabindex="4" class=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div class="collapse-title text-xl font-medium">
                ...
                <div tabindex="5" class=" mb-4 collapse collapse-arrow border border-base-300 bg-base-100   rounded-xl">
                    <div class="collapse-title text-xl font-medium">
